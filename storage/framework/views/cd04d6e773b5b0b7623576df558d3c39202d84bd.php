...
<div class="table-responsive">
    <table class="table table-striped table-sm">
        <thead>
        <tr>
            <!--TODO lokalizáció kezelése-->
            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('id', 'Megrendelés azonosító'));?></th>
            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('cid', 'Megrendelő azonosító'));?></th>
            <!--th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('service_id', 'Szolgáltatás azonosító'));?></th-->
            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('service->service_name', 'Szolgáltatás neve'));?></th>
    ...
    <tbody>
        <?php $__currentLoopData = $customer_accountings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accounting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><a href="<?php echo e(route('customers.show', $accounting->cid)); ?>"><?php echo e($accounting->customer); ?></a></td>
                <!--td><?php echo e($accounting->service_id); ?></td-->
                <td><a href="<?php echo e(route('services.show',$accounting->service_id)); ?>"><?php echo e($accounting->service); ?></a></td>
