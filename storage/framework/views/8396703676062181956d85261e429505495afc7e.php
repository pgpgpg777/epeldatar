...
<div class="container">
    ...
    <div class="col-sm-8">
        ...
        <h6><label class="col-md-4 col-form-label text-md-left">Vevő:</label><a href="<?php echo e(route('customers.show',$customer_accounting->cid)); ?>"><?php echo e($customer); ?></a></h6>
        <h6><label class="col-md-4 col-form-label text-md-left">Szolgáltatás:</label><a href="<?php echo e(route('services.show',$customer_accounting->service_id)); ?>"><?php echo e($service); ?></a></h6>
