        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header">Megrendelés létrehozása</div>

                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('customer_accountings.store')); ?>">
                            <?php echo csrf_field(); ?>

                            <div class="form-group row">
                                <label for="cid" class="col-md-4 col-form-label text-md-right">Vevő azonosító</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!--input id="cid" type="text"
                                           ...
                                           name="cid" value="<?php echo e(old('cid')); ?>" required autofocus-->
                            ...
                            <div class="form-group row">
                                <label for="service_id" class="col-md-4 col-form-label text-md-right">Szolgáltatás azonosító</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!--input id="service_id" type="text"
                                           ...
                                           name="service_id" value="<?php echo e(old('service_id')); ?>" required autofocus-->
                            ...
                            <div class="form-group row">
                                <label for="service_start_date" class="col-md-4 col-form-label text-md-right">Szolgáltatási időszak kezdete</label>

                                <div class="col-md-6">
                                    <input id="service_start_date" type="datetime-local"
                                           class="form-control<?php echo e($errors->has('service_start_date') ? ' is-invalid' : ''); ?>"
                                           name="service_start_date" value="<?php echo e(old('service_start_date')); ?>" required autofocus>
                            ...
                            <div class="form-group row">
                                <label for="service_end_date" class="col-md-4 col-form-label text-md-right">Szolgáltatási időszak vége</label>

                                <div class="col-md-6">
                                    <input id="service_end_date" type="datetime-local"
                                           class="form-control<?php echo e($errors->has('service_end_date') ? ' is-invalid' : ''); ?>"
                                           name="service_end_date" value="<?php echo e(old('service_end_date')); ?>" required>
                            ...
                            <div class="form-group row">
                                <label for="order_date" class="col-md-4 col-form-label text-md-right">Megrendelés dátuma</label>

                                <div class="col-md-6">
                                    <input id="order_date" type="datetime-local"
                                           class="form-control<?php echo e($errors->has('order_date') ? ' is-invalid' : ''); ?>"
                                           name="order_date" value="<?php echo e(old('order_date')); ?>" required>
                            ...
                            <div class="form-group row">
                                <label for="order_price" class="col-md-4 col-form-label text-md-right">Számlázási egységár</label>

                                <div class="col-md-6">
                                    <input id="order_price" type="text"
                                           class="form-control<?php echo e($errors->has('order_price') ? ' is-invalid' : ''); ?>"
                                           name="order_price" value="<?php echo e(old('order_price')); ?>" required>
                            ...
                            <div class="form-group row">
                                <label for="billing_period" class="col-md-4 col-form-label text-md-right">Számlázás rendszeressége</label>

                                <div class="col-md-6">
                                    <input id="billing_period" type="number"
                                           class="form-control<?php echo e($errors->has('billing_period') ? ' is-invalid' : ''); ?>"
                                           name="billing_period" required>
                            ...
                            <div class="form-group row">
                                <label for="order_sum_price" class="col-md-4 col-form-label text-md-right">Megrendelés értéke</label>

                                <div class="col-md-6">
                                    <input id="order_sum_price" type="text"
                                           class="form-control<?php echo e($errors->has('order_sum_price') ? ' is-invalid' : ''); ?>"
                                           name="order_sum_price" required>
