                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="user_firstname" type="text"
                                           ...
                                           name="user_firstname" value="<?php echo e(old('user_firstname')); ?>" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="user_lastname" type="text"
                                           ...
                                           name="user_lastname" value="<?php echo e(old('user_lastname')); ?>" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="user_work" type="text"
                                           ...
                                           name="user_work" value="<?php echo e(old('user_work')); ?>" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="user_email" type="email"
                                           ...
                                           name="user_email" value="<?php echo e(old('user_email')); ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="user_phone" type="text"
                                           ...
                                           name="user_phone" value="<?php echo e(old('user_phone')); ?>" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="user_profile_img" type="text"
                                           class="form-control<?php echo e($errors->has('user_profile_img') ? ' is-invalid' : ''); ?>"
                                           name="user_profile_img" value="<?php echo e(old('user_profile_img')); ?>" required>
