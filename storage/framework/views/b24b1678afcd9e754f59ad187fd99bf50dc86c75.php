            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('register')); ?>">
                        ...
                        <div class="form-group row">
                            <label for="user_profile_img" class="col-md-4 col-form-label text-md-right">Profilkép</label>

                            <div class="col-md-6">
                                <input id="user_profile_img" type="text" class="form-control<?php echo e($errors->has('user_profile_img') ? ' is-invalid' : ''); ?>" name="user_profile_img" value="<?php echo e(old('user_profile_img')); ?>" required autofocus>
