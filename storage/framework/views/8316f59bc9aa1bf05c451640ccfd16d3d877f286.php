        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default">
                    <div class="card-header">Felhasználói jogosultság létrehozása</div>

                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('user_rights.store')); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group row">
                                <label for="customer_id" class="col-md-4 col-form-label text-md-right">Vevő azonosító</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!--input id="customer_id" type="text"
                                           class="form-control<?php echo e($errors->has('customer_id') ? ' is-invalid' : ''); ?>"
                                           name="customer_id" value="<?php echo e(old('customer_id')); ?>" required autofocus-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="user_rights" type="text"
                                           ...
                                           name="user_rights" value="<?php echo e(old('user_rights')); ?>" required autofocus>
