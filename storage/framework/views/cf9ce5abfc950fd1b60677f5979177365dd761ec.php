...
<div class="table-responsive">
    ...
    <tbody>
        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                <span><td><a href="<?php echo e(route("users.show",$user->id)); ?>"><?php echo e($user->user_firstname); ?></td></a></span>
                <td><a href="<?php echo e(route("users.show",$user->id)); ?>"><?php echo e($user->user_lastname); ?></td></a>
                <td><a href="<?php echo e(route("users.show",$user->id)); ?>"><?php echo e($user->user_work); ?></td></a>
                <td><a href="<?php echo e(route("users.show",$user->id)); ?>"><?php echo e($user->user_email); ?></td></a>
                <td><a href="<?php echo e(route("users.show",$user->id)); ?>"><?php echo e($user->user_phone); ?></td></a>
                <td><a href="<?php echo e(route("users.show",$user->id)); ?>"><?php echo e($user->user_profile_img); ?></td></a>
                <td><a href="<?php echo e(route("users.show",$user->id)); ?>"><?php echo e($user->user_status); ?></td></a>
