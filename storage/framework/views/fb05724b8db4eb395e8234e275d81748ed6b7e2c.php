...
<hr>
    ...
    <div class="col-sm-8">
        ...
        <h6><label class="col-md-4 col-form-label text-md-left">Vezetéknév:</label><?php echo e($user->user_lastname); ?></h6>

        <h6><label class="col-md-4 col-form-label text-md-left">Keresztnév:</label>
            <?php echo e($user->user_firstname); ?></h6>
...
<br>
        <a href="<?php echo e(route("users.edit",$user->id)); ?>">Profil adatok szerkesztése</a>
    </div>
    </div>
</div>
