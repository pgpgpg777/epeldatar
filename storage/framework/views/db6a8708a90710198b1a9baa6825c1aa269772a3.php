                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="/user_rights">
                                <span data-feather=""></span>
                                &nbsp; Jogosultságok listázása
                            </a>

                            <a class="dropdown-item" href="/user_rights/create">
                                <span data-feather=""></span>
                                &nbsp; Jogosultság létrehozása
                            </a>

                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="/user_rights/delete">
                                <span data-feather=""></span>
                                &nbsp; Jogosultság törlése
                            </a> <!-- delete még nincs -->
                        </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="/customer_accountings">
                                <span data-feather=""></span>
                                &nbsp; Megrendelések listázása
                            </a>

                            <a class="dropdown-item" href="/customer_accountings/create">
                                <span data-feather=""></span>
                                &nbsp; Megrendelés létrehozása
                            </a>

                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="/customer_accountings/delete">
                                <span data-feather=""></span>
                                &nbsp; Megrendelés törlése
                            </a> <!-- delete még nincs -->
                        </div>
