...
<div class="table-responsive">
    <table class="table table-striped table-sm">
        ...
        <tr>
            ...
            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('uid', 'Felhasználó azonosító'));?></th>
            <th><?php echo \Kyslik\ColumnSortable\SortableLink::render(array ('customer_id', 'Vevő azonosító'));?></th>
