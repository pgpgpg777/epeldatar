...
<body>
    <div id="app">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="/users/create">Create users</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="/users/delete">Delete user</a>
        </div>
      </li>
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="/customers/create">Create customers</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="/customers/delete">Delete customer</a>
        </div>
      </li>
                            <li class="nav-item dropdown">
