                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('users.store')); ?>">
                            ...
                            <div class="form-group row">
                                <label for="user_firstname" class="col-md-4 col-form-label text-md-right">First name</label>
                            ...
                            <div class="form-group row">
                                <label for="user_lastname" class="col-md-4 col-form-label text-md-right">Last name</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="user_email" type="email" class="form-control<?php echo e($errors->has('user_email') ? ' is-invalid' : ''); ?>" name="user_email" value="<?php echo e(old('user_email')); ?>" required>
                                ...
                                <div class="form-group row">
                                    <label for="user_phone" class="col-md-4 col-form-label text-md-right">Phone Number</label>

                                    <div class="col-md-6">
                                        <input id="user_phone" type="text" class="form-control<?php echo e($errors->has('user_phone') ? ' is-invalid' : ''); ?>" name="user_phone" value="<?php echo e(old('user_phone')); ?>" required>
                                ...
                                <div class="form-group row">
                                    <label for="user_profile_img" class="col-md-4 col-form-label text-md-right">Profile Image</label>

                                    <div class="col-md-6">
                                        <input id="user_profile_img" type="text" class="form-control<?php echo e($errors->has('user_profile_img') ? ' is-invalid' : ''); ?>" name="user_profile_img" value="<?php echo e(old('user_profile_img')); ?>" required>

                                        <?php if($errors->has('user_profile_img')): ?>
                                            <span class="invalid-feedback">
                                        <strong><?php echo e($errors->first('user_profile_img')); ?></strong>
                                    </span>
                                        <?php endif; ?>
                                    </div>
                                </div>
